package com.eraste.productservice.infrastructure.config;
 ...
 * <p>
 * This class customizes the OpenAPI specification for the Product Service API,
...
public class OpenApiConfig {
    ...
    public OpenAPI productServiceOpenAPI() {
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .description("REST API for product management in the microservices architecture")
                .contact(contact)
                .license(license);
